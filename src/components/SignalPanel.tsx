...
export default function SignalPanel({ 
  ...
  const tournamentResult = useMemo(() => {
    ...
    const candidates: StrategyCandidate[] = [
      { key: 'standard',     label: 'Estándar',        profitFactor: btStandard.profitFactor,  expectancyR: btStandard.expectancyR,  expectancyPerHour: btStandard.expectancyPerHour,  avgExposureHours: btStandard.avgExposureHours,  winRate: btStandard.winRate,  resolved: btStandard.totalSignals > 0 ? btStandard.totalSignals : (btStandard.wins + btStandard.losses), forwardWindow: 6 },
      { key: 'confluencia',  label: 'Confluencia',     profitFactor: btConfluencia.profitFactor, expectancyR: btConfluencia.expectancyR, expectancyPerHour: btConfluencia.expectancyPerHour, avgExposureHours: btConfluencia.avgExposureHours, winRate: btConfluencia.winRate, resolved: btConfluencia.totalSignals > 0 ? btConfluencia.totalSignals : (btConfluencia.wins + btConfluencia.losses), forwardWindow: 6 },
      { key: 'scoring',     label: 'Scoring',        profitFactor: btScoring.profitFactor,expectancyR: btScoring.expectancyR,expectancyPerHour: btScoring.expectancyPerHour,avgExposureHours: btScoring.avgExposureHours,winRate: btScoring.winRate,resolved: btScoring.totalSignals > 0 ? btScoring.totalSignals : (btScoring.wins + btScoring.losses), forwardWindow: 6 },
      { key: 'multitemporal',label: 'VCME Sniper',    profitFactor: btMultitemporal ? btMultitemporal.profitFactor : null, expectancyR: btMultitemporal ? btMultitemporal.expectancyR : 0, expectancyPerHour: btMultitemporal ? btMultitemporal.expectancyPerHour : 0, avgExposureHours: btMultitemporal ? btMultitemporal.avgExposureHours : 0, winRate: btMultitemporal ? btMultitemporal.winRate : 0, resolved: btMultitemporal ? (btMultitemporal.totalSignals > 0 ? btMultitemporal.totalSignals : btMultitemporal.wins + btMultitemporal.losses) : 0, forwardWindow: interval === '1h' ? 48 : 72 },
