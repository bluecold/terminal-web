...
* **Validación Walk-Forward con Histórico Paginado (2000 velas de 5m):** Paginación inteligente en Binance y escala de `evalWindow` a 1400 velas en 5m (980 velas In-Sample / 420 velas Out-of-Sample $\approx 35\,\text{h}$), asegurando entre 8 y 18 trades OOS reales y descartando candidatos sobreajustados (`FAIL`).
