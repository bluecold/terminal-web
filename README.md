...
* **Suite de Pruebas Automatizadas con Fixtures de Oro:** 96 tests unitarios de integración continua (`npm test`) que validan toda la cadena operativa, cálculo matemático, motores de señal, normalización temporal, scoring bayesiano, invarianza de $PF_R$, modulación por régimen, paridad de cooldown, calendario bursátil y partición Walk-Forward de punta a punta.
